    ...
    <div className='flex h-screen items-center'>
      <div className="text-center mx-auto">
        ...
        <div className="flex flex-wrap flex-col md:flex-row justify-center px-20 gap-2">
          <button className="bg-blue-900 text-white rounded py-2 md:px-10 md:py-3">Contact Me</button>
          <button className="bg-blue-900 text-white rounded py-2 md:px-10 md:py-3">Resume</button>
        </div>
      </div>
    </div>
  );
