        ...
        <div className="h-screen lg:px-20 mt-20 lg:mx-20">
            ...
            <ul className='bg-gray-100 mb-6 rounded-2xl p-5 drop-shadow-xl'>
                ...
                <div className="flex xl:flex-row flex-col items-center gap-5">
                    <img class="flex w-64 h-auto object-contain" src="https://images.pexels.com/photos/1092671/pexels-photo-1092671.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"></img>
                    <div>
                        ...
                        <Link to={"https://github.com/Deshan0802/SDGP"}><Icon icon="mingcute:github-line" width="48" height="48" /></Link>
                    </div>
                </div>
            </ul>
            ...
            <ul className='bg-gray-100 mb-6 rounded-2xl p-5 drop-shadow-xl'>
                ...
                <div className="flex xl:flex-row flex-col items-center gap-5">
                    ...
                    <div>
                        ...
                        <Link to={"https://github.com/Romayle/shopping-cart-system"}><Icon icon="mingcute:github-line" width="48" height="48" /></Link>
                    </div>
                </div>
            </ul>
            ...
            <ul className='bg-gray-100 mb-6 rounded-2xl p-5 drop-shadow-xl'>
                ...
                <div className="flex xl:flex-row flex-col items-center gap-5">
                    ...
                    <div>
                        ...
                        <Link to={"https://github.com/Romayle/gallery-web-page"}><Icon icon="mingcute:github-line" width="48" height="48" /></Link>
                    </div>
                </div>
            </ul>
            ...
            <ul className='bg-gray-100 mb-6 rounded-2xl p-5 drop-shadow-xl'>
                ...
                <div className="flex xl:flex-row flex-col items-center gap-5">
                    ...
                    <div>
                        ...
                        <Link to={"https://github.com/Romayle/web-portfolio"}><Icon icon="mingcute:github-line" width="48" height="48" /></Link>
                    </div>
                </div>
            </ul>
